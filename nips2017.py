...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 23 18:36:50 2020
...
init_url = 'https://aaai.org/Library/AAAI/aaai20contents-issue03.php#11'
# create current dict
title_list = []
paper_dict = dict()
...
for p in tqdm(zip(paper_list, range(num_download))):
    ...
    for _ in range(3):
        try:
            abs_content = urlopen('https://aaai.org/ojs/index.php/AAAI'+url2, timeout=20).read()
            ...
            # download paper
            filename = wget.download('https://aaai.org/ojs/index.php/AAAI' + paper_link, 'main.pdf')
            ...
            try:
                supp_filename = wget.download('https://aaai.org/ojs/index.php/AAAI' + supp_link, 'supp.' + supp_type)
...
with open('AAAI2019_pre.dat','wb') as f:
